...
<template>
  ...
  <header class="header">
      ...
      <a href="login.vue" ><img src="./loginlogo.jpg"></a>
...
<style>
  ...
  .qr-code-container {
    display: grid;
    grid-template-columns: 1fr; /* Keep this for responsiveness */
    gap: 20px;
    max-width: 800px;
    margin: 20px auto;
...
/* Optionally, you can add styles to center the QR code container */
#qr-code-container {
  display: flex;
  justify-content: center;
}
  ...
  aside1 {
    /* Assuming "aside1" to "aside6" are the classes for your asides */
    grid-column: 1; /* Align to the first column (left) within the container */
    text-align: left; /* Align text to the left within the aside */
  }
